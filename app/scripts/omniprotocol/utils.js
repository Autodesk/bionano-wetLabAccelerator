(function (window, document, _, undefined) {
  ...
  /*
   MUST BE FIRST FILE LOADED
   todo - should use some sort of module loading for this...
   */
  ...
  var op    = window.omniprotocol || (window.omniprotocol = {}),
      utils = op.utils || (op.utils = {});
  ...
  if (window.omniprotocol.utils.pluckField) {
    console.warn('already set up omniprotocol utils');
  } else {
    _.extend(utils, {
